...
import com.pan1024.dao.BiliUserAdo;
 ...
 * @describe:
 */
public class BiliSpiderPageProcessor implements PageProcessor {
    ...
    private static final long BEGIN_MID = 3145727;    //开始用户mid
    ...
    public static void main(String[] args) {
        ...
        Spider spider = Spider.create(new BiliSpiderPageProcessor());
        //添加请求对象序列
        long mid;
